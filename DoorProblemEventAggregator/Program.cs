...
namespace DoorProblemEventAggregator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            eventAggregator.Subscribe<SmartDoor>(door => autoClose.AutoCloseFun(door));
            eventAggregator.Subscribe<SmartDoor>(door => noise.Update(door));
            eventAggregator.Subscribe<SmartDoor>(door => notification.Update(door));
